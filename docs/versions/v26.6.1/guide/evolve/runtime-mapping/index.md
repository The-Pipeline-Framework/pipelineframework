...
- [Runtime Layouts and Build Topologies](/versions/v26.6.1/guide/build/runtime-layouts/)
...
- [Schema and Semantics](/versions/v26.6.1/guide/evolve/runtime-mapping/schema)
- [Synthetic Step Identifiers](/versions/v26.6.1/guide/evolve/runtime-mapping/synthetics)
- [Annotation Processing and Transport](/versions/v26.6.1/guide/evolve/runtime-mapping/annotation-processing)
- [Validation, Migration, and Examples](/versions/v26.6.1/guide/evolve/runtime-mapping/validation-migration-examples)
- [Build Topologies (What Is Real Today)](/versions/v26.6.1/guide/evolve/runtime-mapping/build-topologies)
- [Cheat Sheet](/versions/v26.6.1/guide/evolve/runtime-mapping/cheat-sheet)
...
- [TDD Plan](/versions/v26.6.1/guide/evolve/runtime-mapping/tdd-plan)
- [Implementation Plan](/versions/v26.6.1/guide/evolve/runtime-mapping/implementation-plan)
