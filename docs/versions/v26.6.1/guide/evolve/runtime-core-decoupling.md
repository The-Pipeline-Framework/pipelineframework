...
For the surrounding configuration model, see [build configuration](/versions/v26.6.1/guide/build/configuration/) and
...
[annotation processor generation and rendering](/versions/v26.6.1/guide/evolve/annotation-processor/generation-and-rendering).
