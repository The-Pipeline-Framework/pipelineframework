...
If you want the value-led overview before the mechanics, start with [State, Replay, and Queryable Data](/versions/v26.6.2/value/state-replay-and-queryable-data).
