...
For the surrounding configuration model, see [build configuration](/versions/v26.6.2/develop/configuration/) and
...
[annotation processor generation and rendering](/versions/v26.6.2/evolve/annotation-processor/generation-and-rendering).
