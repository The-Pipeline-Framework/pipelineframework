...
public interface UnapprovedPaymentStatusMapper
    extends org.pipelineframework.mapper.Mapper<
        UnapprovedPaymentStatus, PipelineTypes.UnapprovedPaymentStatus> {
  ...
  PipelineTypes.UnapprovedPaymentStatus toGrpcPayload(UnapprovedPaymentStatus domain);
  ...
  @Mapping(target = "paymentRecord", ignore = true)
  UnapprovedPaymentStatus fromGrpcPayload(PipelineTypes.UnapprovedPaymentStatus grpc);
