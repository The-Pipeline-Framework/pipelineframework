...
> For topology migration guidance, see [Runtime Layouts and Build Topologies](/versions/v26.6.1/guide/build/runtime-layouts/) in the section below.
...
For await suspend/resume internals, see [Await Unit Runtime](/versions/v26.6.1/guide/evolve/await-unit-runtime/).
