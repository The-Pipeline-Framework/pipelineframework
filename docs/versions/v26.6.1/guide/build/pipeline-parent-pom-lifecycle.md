...
Reference template: [`template-generator-node/templates/parent-pom.hbs`](https://github.com/The-Pipeline-Framework/tpf-mcp-bridge/blob/main/template-generator-node/templates/parent-pom.hbs)

> **Scope**
> This is the baseline lifecycle generated by the Web UI Canvas Designer scaffold.
...
> - [Using the Canvas Designer](/versions/v26.6.1/guide/getting-started/canvas-guide)
...
> - [CSV Payments POM Lifecycle](/versions/v26.6.1/guide/build/csv-payments-pom-lifecycle) for an example-specific variant
