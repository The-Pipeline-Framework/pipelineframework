...
This guide is implementation-facing. Application-facing usage lives in [Await Boundaries](/versions/v26.6.1/guide/development/orchestrator-runtime/await).

For the longer-term orchestration boundary that can move await units out of each app-hosted orchestrator, see [Durable Coordinator](/versions/v26.6.1/guide/evolve/durable-coordinator/).

## Guide Pages

1. [Model](/versions/v26.6.1/guide/evolve/await-unit-runtime/) explains the durable records and cardinality semantics.
2. [Sequences](/versions/v26.6.1/guide/evolve/await-unit-runtime/sequences) shows unary, stream, aggregate, timeout, and resume flows.
3. [Patterns](/versions/v26.6.1/guide/evolve/await-unit-runtime/patterns) explains the architectural patterns and why the unit model fixed the design.
4. [Limitations And Debt](/versions/v26.6.1/guide/evolve/await-unit-runtime/operations-and-debt) tracks implementation limitations and follow-up work.
