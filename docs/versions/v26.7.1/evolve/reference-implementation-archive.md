...
This scaffold walkthrough predates the current IA and connector/FCIS positioning. Use [Reference Implementations](/versions/v26.7.1/evolve/reference-implementation) for the current reading path.
:::

::: warning Legacy Reference
This page still contains useful examples, but it predates the current docs IA and the stronger connector/FCIS positioning. Prefer [Pipeline Compilation](/versions/v26.7.1/develop/pipeline-compilation/), [Configuration](/versions/v26.7.1/develop/configuration/), [Object Ingest](/versions/v26.7.1/design/object-ingest), and [MCP and Template Generation](/versions/v26.7.1/develop/mcp-template-generation) for current user-facing guidance.
:::
