...
- [Persistence Plugin](/versions/v26.8.1/design/persistence)
- [JPA Query Connector](/versions/v26.8.1/design/jpa-query-connector/)
...
- [Orchestrator Runtime](/versions/v26.8.1/deploy/orchestrator-runtime/)
