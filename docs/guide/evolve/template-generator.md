...
- <https://github.com/mbarcia/pipelineframework/blob/main/template-generator-node/src/pipeline-template-schema.json>
...
- [Code a Step](/guide/development/code-a-step): Learn more about implementing pipeline steps
- [Orchestrator Runtime](/guide/development/orchestrator-runtime): Understand orchestration configuration
- [Error Handling & DLQ](/guide/operations/error-handling): Implement robust error handling
- [Observability Overview](/guide/operations/observability/): Monitor and observe your pipeline applications
- [Testing Guidelines](/guide/evolve/testing-guidelines): Write tests for your pipeline components
