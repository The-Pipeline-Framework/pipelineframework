...
Application-facing guidance lives in [Await Boundaries](/versions/v26.6.1/guide/development/orchestrator-runtime/await). Operational guidance lives in [Await Boundary Operations](/versions/v26.6.1/guide/operations/await-boundaries).
