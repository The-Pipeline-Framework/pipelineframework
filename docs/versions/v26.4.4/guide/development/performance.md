...
Parallelism is configured at the pipeline level. See the [Configuration Reference](/versions/v26.4.4/guide/build/configuration/) for the exact settings.
...
[Expansion and Reduction](/versions/v26.4.4/guide/design/expansion-and-reduction).
