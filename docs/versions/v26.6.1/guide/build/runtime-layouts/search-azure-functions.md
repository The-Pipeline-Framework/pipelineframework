...
Maintainer-only notes for GitHub OIDC subjects and workflow dispatch details live in [CI Guidelines](/versions/v26.6.1/guide/evolve/ci-guidelines#search-cloud-example-workflows).
...
- Review [AWS Lambda Platform (Development)](/versions/v26.6.1/guide/development/aws-lambda) for Function platform concepts
