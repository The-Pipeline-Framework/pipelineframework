...
public final class StepDefinitionBuildItem extends MultiBuildItem {
     ...
     * @param stepCardinality a string describing the step cardinality; must not be null or blank
     * @throws NullPointerException if {@code stepName} or {@code stepCardinality} is null
     * @throws IllegalArgumentException if {@code stepName} or {@code stepCardinality} is blank
     */
    public StepDefinitionBuildItem(String stepName, DotName domainIn, DotName domainOut, String stepCardinality) {
        ...
        if (this.stepCardinality.isBlank()) {
            throw new IllegalArgumentException("stepCardinality must not be blank");
        }
