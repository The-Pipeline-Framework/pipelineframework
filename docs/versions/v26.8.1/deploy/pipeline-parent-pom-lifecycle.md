...
> **Scope**
> This is the baseline lifecycle generated from the pipeline template scaffold.
> It describes the default modular build wiring (parent + modules) before any
> custom topology migration.
>
> Runtime mapping (`pipeline.runtime.yaml`) influences placement and generated
> wiring, but it does not, by itself, rewrite Maven modules/POM structure.
...
> - [CSV Payments POM Lifecycle](/versions/v26.8.1/deploy/csv-payments-pom-lifecycle) for an example-specific variant
