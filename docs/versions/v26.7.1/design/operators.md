...
- gRPC transport: requires protobuf descriptors and mapper-compatible bindings for delegated/operator paths (see [Application Configuration](/versions/v26.7.1/develop/configuration/)).
...
- [Application Configuration](/versions/v26.7.1/develop/configuration/)
- [Developing with Operators](/versions/v26.7.1/develop/operators)
- [Operator Runtime Operations](/versions/v26.7.1/operate/operators)
- [Operator Playbook](/versions/v26.7.1/operate/operators-playbook)
- [Operator Troubleshooting](/versions/v26.7.1/operate/operators-troubleshooting)
- [Operator Internals](/versions/v26.7.1/evolve/operators/internals)
