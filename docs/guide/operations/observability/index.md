...
- [Working with NewRelic OTel](/guide/operations/observability/newrelic): Enabing OTel export to use NewRelic 
- [Test locally using LGMT](/guide/operations/observability/lgtm): Enabling Prometheus metrics for Grafana dashboards on Quarkus LGTM stack
