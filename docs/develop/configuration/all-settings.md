...
| `pipeline.max-recursive-depth` | integer | `64` | Maximum number of recursive local pipeline invocations below a root invocation. The first call beyond this depth fails without retry. |
