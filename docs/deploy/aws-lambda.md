...
This page is the canonical TPF guide for `FUNCTION` platform builds that target AWS Lambda. For the broader multi-cloud function story, pair it with the [Multi-Cloud Function Providers Guide](/deploy/function-providers).
...
- [Configuration (Overview)](/develop/configuration/)
