...
For the role split behind coordinator, transition worker, step/runtime services, and the historical `orchestrator-svc` name, see [Coordinator And Worker Topology](/versions/v26.6.2/evolve/durable-coordinator/coordinator-worker-topology).
...
For metric names and observability surfaces, use the operations guides for [Metrics](/versions/v26.6.2/operate/observability/metrics), [Replay & Live Topology](/versions/v26.6.2/operate/observability/replay), and the [Operator Playbook](/versions/v26.6.2/operate/operators-playbook).
