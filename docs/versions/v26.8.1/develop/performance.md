...
Parallelism is configured at the pipeline level. See [All Settings](/versions/v26.8.1/develop/configuration/all-settings) for the exact settings.
...
[Expansion and Reduction](/versions/v26.8.1/design/expansion-and-reduction).
