...
hero:
  ...
  actions:
    - theme: alt
      text: Quick Start
      link: /versions/v26.6.1/guide/getting-started/
    - theme: brand
...
<div class="home-capability-grid">
  <a class="home-capability-card" href="/versions/v26.6.1/value/developer-experience">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/guide/build/pipeline-compilation">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/guide/development/operators">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/guide/development/orchestrator-runtime/">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/value/runtime-efficiency">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/value/integration-flexibility">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/value/deployment-evolution">
  ...
  <a class="home-capability-card" href="/versions/v26.6.1/value/state-replay-and-queryable-data">
...
You write typed Java functions and declare their order in YAML. TPF checks the flow at build time, including whether each function shape is valid, whether outputs match the next inputs, whether [mappers](/versions/v26.6.1/guide/development/mappers-and-dtos) convert types correctly, whether [operators](/versions/v26.6.1/guide/development/operators) are valid, and whether the generated code can call each function cleanly.
...
Start with [pipeline compilation](/versions/v26.6.1/guide/build/pipeline-compilation) when you want the build-time generation model, or [code a step](/versions/v26.6.1/guide/development/code-a-step) when you want to implement the function itself.
...
The exact config value for this mode is `QUEUE_ASYNC`; start with the [Orchestrator Runtime](/versions/v26.6.1/guide/development/orchestrator-runtime/) guide before using it in production.
...
[Plugins](/versions/v26.6.1/guide/development/using-plugins) add declared cross-cutting work such as persistence, cache, telemetry, and logging. An **aspect** is the rule that says where the plugin runs, for example before or after a step; the plugin provides the implementation.
...
See [State, Replay, and Queryable Data](/versions/v26.6.1/value/state-replay-and-queryable-data) for the full persistence-and-caching story.
...
- [Quick Start](/versions/v26.6.1/guide/getting-started/) for the fastest path to a runnable scaffold.
- [Pipeline Compilation](/versions/v26.6.1/guide/build/pipeline-compilation) for YAML-first generation and build-time validation.
- [Operators](/versions/v26.6.1/guide/development/operators) for reusing existing Java methods or remote endpoints.
- [Runtime Layouts](/versions/v26.6.1/guide/build/runtime-layouts/) for logical placement versus Maven/container build topology.
- [AWS Lambda Platform](/versions/v26.6.1/guide/development/aws-lambda) for the canonical `FUNCTION` platform guide.
- [Azure Functions Platform](/versions/v26.6.1/guide/development/azure-functions) for Azure development-time guidance.
- [Google Cloud Run Functions Platform](/versions/v26.6.1/guide/development/google-cloud-run-functions) for the Google function-platform path.
- [Multi-Cloud Function Providers](/versions/v26.6.1/guide/build/runtime-layouts/function-providers) for provider-specific function deployment targets.
- [Orchestrator Runtime](/versions/v26.6.1/guide/development/orchestrator-runtime/) for synchronous execution, background execution, crash recovery, and DLQ behaviour.
- [Using Plugins](/versions/v26.6.1/guide/development/using-plugins) for persistence, cache, telemetry, and logging extensions.
- [TPFGo Example](/versions/v26.6.1/guide/development/tpfgo-example) for checkpoint handoff between pipelines.
