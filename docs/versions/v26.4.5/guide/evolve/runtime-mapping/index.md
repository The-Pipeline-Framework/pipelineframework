...
- [Runtime Layouts and Build Topologies](/versions/v26.4.5/guide/build/runtime-layouts/)
- [Using Runtime Mapping](/versions/v26.4.5/guide/build/runtime-layouts/using-runtime-mapping)
- [Maven Migration Playbook](/versions/v26.4.5/guide/build/runtime-layouts/maven-migration)

## Contents

- [Schema and Semantics](/versions/v26.4.5/guide/evolve/runtime-mapping/schema)
- [Synthetic Step Identifiers](/versions/v26.4.5/guide/evolve/runtime-mapping/synthetics)
- [Annotation Processing and Transport](/versions/v26.4.5/guide/evolve/runtime-mapping/annotation-processing)
- [Validation, Migration, and Examples](/versions/v26.4.5/guide/evolve/runtime-mapping/validation-migration-examples)
- [Build Topologies (What Is Real Today)](/versions/v26.4.5/guide/evolve/runtime-mapping/build-topologies)
- [Cheat Sheet](/versions/v26.4.5/guide/evolve/runtime-mapping/cheat-sheet)
...
- [TDD Plan](/versions/v26.4.5/guide/evolve/runtime-mapping/tdd-plan)
- [Implementation Plan](/versions/v26.4.5/guide/evolve/runtime-mapping/implementation-plan)
