...
If you are looking for the broader value story behind persistence plus caching, start with [State, Replay, and Queryable Data](/versions/v26.6.1/value/state-replay-and-queryable-data) and [Cache vs Persistence](/versions/v26.6.1/guide/plugins/caching/cache-vs-persistence).
