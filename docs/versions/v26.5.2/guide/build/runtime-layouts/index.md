...
- Validation behaviour ([`auto` = best-effort fallback placement, `strict` = fail on unmapped/mismatched placement](/versions/v26.5.2/guide/evolve/runtime-mapping/schema#validation)).
...
- [POM vs Layout Matrix](/versions/v26.5.2/guide/build/runtime-layouts/pom-layout-matrix)
...
- [Search Lambda Verification Lane](/versions/v26.5.2/guide/build/runtime-layouts/search-lambda)
