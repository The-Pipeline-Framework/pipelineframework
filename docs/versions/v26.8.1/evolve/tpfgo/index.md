...
3) **Roadmap (Pessimist's Notebook)**
   - [Roadmap: Checkpoint Pipelines vs FTGO](/versions/v26.8.1/evolve/tpfgo/roadmap)
   - Risks, open questions, and practical next steps.

4) **Observer/Tap Contract (Diagnostics-First)**
   - [Observer and Tap Contract](/versions/v26.8.1/evolve/tpfgo/observer-tap-contract)
