...
- Build transport and platform defaults from `pipeline.yaml` (the pipeline manifest, typically at the repo root or a service `config/` directory; see [Configuration](/versions/v26.7.1/develop/configuration/)).
...
- [Operator Troubleshooting Matrix](/versions/v26.7.1/operate/operators-troubleshooting)
- [Operator Build Troubleshooting](/versions/v26.7.1/develop/operators-build-troubleshooting)
- [Error Handling and Recovery](/versions/v26.7.1/operate/error-handling)
- [Observability](/versions/v26.7.1/operate/observability/)
