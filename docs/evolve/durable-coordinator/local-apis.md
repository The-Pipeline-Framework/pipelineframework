...
For how these APIs relate to coordinator and worker processes, see [Coordinator And Worker Topology](/evolve/durable-coordinator/coordinator-worker-topology).
