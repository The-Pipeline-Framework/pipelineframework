...
For the surrounding configuration model, see [build configuration](/versions/v26.7.1/develop/configuration/) and
...
[annotation processor generation and rendering](/versions/v26.7.1/evolve/annotation-processor/generation-and-rendering).
