...
# Roadmap Archive: Checkpoint Pipelines vs FTGO

::: warning Archived Notebook
This is the original long-form pessimist notebook. Use [TPFGo Roadmap](/versions/v26.7.1/evolve/tpfgo/roadmap) for the current reading path.
:::

::: warning Strategy Notebook
This is a design notebook, not product documentation. Keep application-facing FCIS and checkpoint guidance in [Functional Core, Imperative Shell](/versions/v26.7.1/design/fcis), [State Model](/versions/v26.7.1/design/state-model), and [Checkpoint Handoff](/versions/v26.7.1/deploy/orchestrator-runtime/checkpoint-handoff).
:::
...
- [TPF and DDD Alignment](/versions/v26.7.1/evolve/tpfgo/ddd-alignment)
- [Application Design Spectrum](/versions/v26.7.1/evolve/tpfgo/design-spectrum)
