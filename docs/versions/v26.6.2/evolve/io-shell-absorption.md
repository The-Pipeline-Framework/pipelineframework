...
This page is the internal strategy companion to the public [Functional Core, Imperative Shell](/versions/v26.6.2/design/fcis) guide. Keep public docs focused on typed boundaries and connector usage; use this page for evolution decisions about which I/O shells TPF should absorb next.
:::
...
For the current user-facing JPA connector shape, see [JPA Query Connector](/versions/v26.6.2/design/jpa-query-connector/).
