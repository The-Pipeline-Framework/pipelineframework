...
For detailed command history and the original long-form notes, see [Search Azure Functions Reference](/versions/v26.7.1/deploy/search-azure-functions-reference#cloud-deployment-with-terraform).
