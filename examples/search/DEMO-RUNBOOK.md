...
Kris' concern is the classic producer/consumer mismatch: document chunking can emit work faster than an embedding model can consume it. A common answer is to add an ad hoc Redis queue or `PipeDoc` buffer between the chunker and embedder.
