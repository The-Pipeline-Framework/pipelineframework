...
See [AWS Lambda Platform Guide](/deploy/aws-lambda) for detailed deployment instructions.
...
- See [Function Platform Architecture](/evolve/compiler-pipeline-architecture) for implementation details
- Consult [Operations Playbook](/operate/operators-playbook) for production guidance
