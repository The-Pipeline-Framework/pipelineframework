...
This is the long-form reference for operator delegation. Start with [External Library Delegation](/develop/external-library-delegation) unless you already know which implementation detail you need.
:::
