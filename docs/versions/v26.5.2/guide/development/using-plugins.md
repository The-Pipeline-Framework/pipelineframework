...
- **Aspects**: declarations that say where and when a plugin should run, such as before or after a step; see the [aspect semantics reference](/versions/v26.5.2/guide/evolve/aspects/semantics) for the formal rules.
