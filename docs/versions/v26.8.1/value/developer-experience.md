...
Quarkus is the mature production runtime today. Spring support has started for a limited local/REST unary path; see [Spring Support Status](/versions/v26.8.1/develop/spring-support) before planning Spring-based applications.
...
- [Operators](/versions/v26.8.1/design/operators)
- [Item Reject Sink](/versions/v26.8.1/develop/item-reject-sink)
- [Mappers and DTOs](/versions/v26.8.1/develop/mappers-and-dtos)
- [Testing](/versions/v26.8.1/develop/testing)
