...
This scaffold walkthrough predates the current IA and connector/FCIS positioning. Use [Reference Implementations](/versions/v26.8.1/evolve/reference-implementation) for the current reading path.
:::

::: warning Legacy Reference
This page still contains useful examples, but it predates the current docs IA and the stronger connector/FCIS positioning. Prefer [Pipeline Compilation](/versions/v26.8.1/develop/pipeline-compilation/), [Configuration](/versions/v26.8.1/develop/configuration/), and [Object Ingest](/versions/v26.8.1/design/object-ingest) for current user-facing guidance.
:::
