...
- **Clear extension points**: Use [Using Plugins](/versions/v26.2.5/guide/development/using-plugins) and [Aspect Semantics](/versions/v26.2.5/guide/evolve/aspects/semantics) as primary references.
...
- **Fast onboarding and testing**: Design visually with Canvas and validate behavior via [Testing with Testcontainers](/versions/v26.2.5/guide/development/testing).
