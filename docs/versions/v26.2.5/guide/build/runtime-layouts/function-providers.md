...
See [AWS Lambda Platform Guide](/versions/v26.2.5/guide/development/aws-lambda) for detailed deployment instructions.
...
- See [Function Platform Architecture](/versions/v26.2.5/guide/evolve/compiler-pipeline-architecture.md) for implementation details
- Consult [Operations Playbook](/versions/v26.2.5/guide/operations/operators-playbook.md) for production guidance
