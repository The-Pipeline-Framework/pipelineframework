...
For `pipeline.platform=FUNCTION` (serverless/function runtime target; see [Configuration Reference](/versions/v26.5.2/guide/build/configuration/)), runtime mapping and function transport contract metadata work together:
