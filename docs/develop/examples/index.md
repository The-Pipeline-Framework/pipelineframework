...
- [Turnkey RAG](https://github.com/The-Pipeline-Framework/rag-turnkey/blob/main/README.md) for two independently deployable applications using Blocks, Query, Command, object ingest, and vector storage;
