...
- [Configuration Reference](/versions/v26.2.5/guide/build/configuration/) for full build-time and runtime key catalog
- [Performance](/versions/v26.2.5/guide/development/performance) for throughput/latency tuning
...
- Lambda development model and gateway choices: [AWS Lambda Platform (Development)](/versions/v26.2.5/guide/development/aws-lambda)
- Lambda runtime operations and SnapStart: [AWS Lambda SnapStart (Operate)](/versions/v26.2.5/guide/operations/aws-lambda-snapstart)
