...
This is the long-form reference for operator delegation. Start with [External Library Delegation](/versions/v26.7.1/develop/external-library-delegation) unless you already know which implementation detail you need.
:::

::: tip Current Reading Path
Use this page for implementation details behind delegated steps. Start with [Operators](/versions/v26.7.1/design/operators) for the application design model, then return here when wiring an external library or operator boundary.
:::
