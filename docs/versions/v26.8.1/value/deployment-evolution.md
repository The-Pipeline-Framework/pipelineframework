...
See the [Runtime Layouts guide](/versions/v26.8.1/deploy/runtime-layouts/) for the packaging details: choosing a monolith-style runtime does not automatically remove per-step service modules because build topology and runtime layout are separate decisions.
