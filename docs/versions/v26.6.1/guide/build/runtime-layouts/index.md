...
::: note
In durable self-host HA, `orchestrator-svc` is a module/artifact name, not always the whole orchestration role. The durable coordinator and transition worker roles are selected by runtime config. See [Coordinator And Worker Topology](/versions/v26.6.1/guide/evolve/durable-coordinator/coordinator-worker-topology).
:::
...
- Validation behaviour ([`auto` = best-effort fallback placement, `strict` = fail on unmapped/mismatched placement](/versions/v26.6.1/guide/evolve/runtime-mapping/schema#validation)).
...
- [POM vs Layout Matrix](/versions/v26.6.1/guide/build/runtime-layouts/pom-layout-matrix)
- [Using Runtime Mapping](/versions/v26.6.1/guide/build/runtime-layouts/using-runtime-mapping)
- [Maven Migration Playbook](/versions/v26.6.1/guide/build/runtime-layouts/maven-migration)
- [CSV Payments Pipeline-Runtime Walkthrough](/versions/v26.6.1/guide/build/runtime-layouts/csv-payments-pipeline-runtime)
- [CSV Payments Monolith Walkthrough](/versions/v26.6.1/guide/build/runtime-layouts/csv-payments-monolith)
- [Search Lambda Verification Lane](/versions/v26.6.1/guide/build/runtime-layouts/search-lambda)
