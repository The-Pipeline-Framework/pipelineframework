...
The orchestrator is generated, but you can extend or replace parts of it when you need stricter control over execution flow. See [Orchestrator runtime extension](/develop/extension/orchestrator-runtime) for the deeper guide.
...
You can wrap that behavior without changing pipeline contracts. See [Reactive services extension](/develop/extension/reactive-services) for the detailed contract.
...
They are a good place for call-specific concerns. See [Client steps extension](/develop/extension/client-steps) for generated client-step customization.
...
See [REST resources extension](/develop/extension/rest-resources) for endpoint-level customization.
...
1. [Orchestrator runtime extension](/develop/extension/orchestrator-runtime)
2. [Reactive services extension](/develop/extension/reactive-services)
3. [Client steps extension](/develop/extension/client-steps)
4. [REST resources extension](/develop/extension/rest-resources)
