...
- **Aspects**: declarations that say where and when a plugin should run, such as before or after a step; see the [aspect semantics reference](/evolve/aspects/semantics) for the formal rules.
