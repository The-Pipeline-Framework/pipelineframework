...
- [Annotation Processor Guide](/versions/v26.6.1/guide/evolve/annotation-processor/): Deep dive into build-time phases, IR, bindings, and renderers
- [Brokered Runtime Boundaries](/versions/v26.6.1/guide/evolve/brokered-boundaries/): Architecture guardrails for Kafka/SQS-style substrates under TPF-owned runtime semantics
- [Boundary Taxonomy](/versions/v26.6.1/guide/evolve/brokered-boundaries/boundary-taxonomy): Mapping between broker concepts and TPF runtime boundaries
- [Envelope And Data Policy](/versions/v26.6.1/guide/evolve/brokered-boundaries/envelope-and-data-policy): Design guidance for typed DTOs, generated protobuf, loose envelopes, and payload references
