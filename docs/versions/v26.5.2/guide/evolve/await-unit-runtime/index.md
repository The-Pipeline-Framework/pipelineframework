...
This guide is implementation-facing. Application-facing usage lives in [Await Boundaries](/versions/v26.5.2/guide/development/orchestrator-runtime/await).

## Guide Pages

1. [Model](/versions/v26.5.2/guide/evolve/await-unit-runtime/) explains the durable records and cardinality semantics.
2. [Sequences](/versions/v26.5.2/guide/evolve/await-unit-runtime/sequences) shows unary, stream, aggregate, timeout, and resume flows.
3. [Patterns](/versions/v26.5.2/guide/evolve/await-unit-runtime/patterns) explains the architectural patterns and why the unit model fixed the design.
4. [Operations And Debt](/versions/v26.5.2/guide/evolve/await-unit-runtime/operations-and-debt) covers checkpoint handoff, limitations, and tracked follow-up work.
