...
| Replay duration | `19.685s` |
| Effective replay throughput | `50.8 records/s` |
| Replay events | `17006` |
...
| --- | --- |
| First status event | `1.573s` |
| Last input parser event | `16.208s` |
| Last live admission release | `18.916s` |
| Object Publish | `19.685s` |
