...
This is the long-form Maven Central and release reference. Start with [Publishing](/versions/v26.8.1/evolve/publishing), [Framework Release Process](/versions/v26.8.1/evolve/framework-release-process), or [Docs Snapshot Process](/versions/v26.8.1/evolve/docs-snapshot-process) for the canonical path.
:::
