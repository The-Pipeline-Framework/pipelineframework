...
This is the older broad architecture overview. Use [Architecture](/versions/v26.6.2/evolve/architecture) for the current canonical reading path.
:::

::: tip Current Architecture Lens
Read this as implementation architecture. For application-facing concepts, route readers to [Functional Core, Imperative Shell](/versions/v26.6.2/design/fcis), [State Model](/versions/v26.6.2/design/state-model), [Runtime Layouts](/versions/v26.6.2/deploy/runtime-layouts/), and [Observability](/versions/v26.6.2/operate/observability/).
:::
...
- [Annotation Processor Guide](/versions/v26.6.2/evolve/annotation-processor/): Deep dive into build-time phases, IR, bindings, and renderers
- [Brokered Runtime Boundaries](/versions/v26.6.2/evolve/brokered-boundaries/): Architecture guardrails for Kafka/SQS-style substrates under TPF-owned runtime semantics
- [Boundary Taxonomy](/versions/v26.6.2/evolve/brokered-boundaries/boundary-taxonomy): Mapping between broker concepts and TPF runtime boundaries
- [Envelope And Data Policy](/versions/v26.6.2/evolve/brokered-boundaries/envelope-and-data-policy): Design guidance for typed DTOs, generated protobuf, loose envelopes, and payload references
