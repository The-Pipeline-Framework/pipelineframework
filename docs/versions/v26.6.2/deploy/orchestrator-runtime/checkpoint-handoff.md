...
For the broader application design model, see [State Model](/versions/v26.6.2/design/state-model), [Functional Core, Imperative Shell](/versions/v26.6.2/design/fcis), and [Await Boundaries](/versions/v26.6.2/design/await-boundaries).
