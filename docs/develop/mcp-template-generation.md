...
For current advanced application design, keep YAML as the canonical model and use [Pipeline Compilation](/develop/pipeline-compilation/) to understand what the framework validates and generates.
