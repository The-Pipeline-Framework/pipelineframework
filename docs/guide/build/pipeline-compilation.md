...
> **Important**
> The default project structure and parent POM lifecycle described in this section come from the scaffold generated by the Web UI Canvas Designer (or template generator).
...
> For topology migration guidance, see [Runtime Layouts and Build Topologies](/guide/build/runtime-layouts/), [Using Runtime Mapping](/guide/build/runtime-layouts/using-runtime-mapping), and [Maven Migration Playbook](/guide/build/runtime-layouts/maven-migration).
