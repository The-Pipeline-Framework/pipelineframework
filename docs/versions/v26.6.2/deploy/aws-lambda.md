...
This page is the canonical TPF guide for `FUNCTION` platform builds that target AWS Lambda. For the broader multi-cloud function story, pair it with the [Multi-Cloud Function Providers Guide](/versions/v26.6.2/deploy/function-providers).
...
- [Google Cloud Run Functions Platform](/versions/v26.6.2/deploy/google-cloud-run-functions)
...
- [AWS Lambda SnapStart (Operate)](/versions/v26.6.2/operate/aws-lambda-snapstart)
- [Configuration (Overview)](/versions/v26.6.2/develop/configuration/)
