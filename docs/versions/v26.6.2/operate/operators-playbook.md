...
- Build transport and platform defaults from `pipeline.yaml` (the pipeline manifest, typically at the repo root or a service `config/` directory; see [Configuration](/versions/v26.6.2/develop/configuration/)).
...
- [Operator Troubleshooting Matrix](/versions/v26.6.2/operate/operators-troubleshooting)
- [Operator Build Troubleshooting](/versions/v26.6.2/develop/operators-build-troubleshooting)
- [Error Handling and Recovery](/versions/v26.6.2/operate/error-handling)
