...
See [AWS Lambda Platform Guide](/versions/v26.6.2/deploy/aws-lambda) for detailed deployment instructions.
...
See [Search Azure Verification Lane](/versions/v26.6.2/deploy/search-azure-functions) and [Azure Functions Deployment Walkthrough](/versions/v26.6.2/deploy/azure-functions-deployment-walkthrough) for the current Azure verification and deployment path.
...
- See [Function Platform Architecture](/versions/v26.6.2/evolve/compiler-pipeline-architecture) for implementation details
- Consult [Operations Playbook](/versions/v26.6.2/operate/operators-playbook) for production guidance
