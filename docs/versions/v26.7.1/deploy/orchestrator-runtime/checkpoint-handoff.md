...
For the broader application design model, see [State Model](/versions/v26.7.1/design/state-model), [Functional Core, Imperative Shell](/versions/v26.7.1/design/fcis), and [Await Boundaries](/versions/v26.7.1/design/await-boundaries).
