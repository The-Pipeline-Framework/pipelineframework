...
| Need | Use |
| --- | --- |
| Call an existing local Java method with compatible input/output types | [Use Existing Java Methods](/develop/extension/use-existing-java-methods) |
| Call a reusable operator service with its own DTO/entity model | [Operator Service Contracts](/develop/extension/operator-service-contracts) |
| Move old annotation-driven delegation into YAML-first configuration | [Legacy Delegation Migration](/develop/extension/legacy-delegation-migration) |
...
The longer implementation reference is preserved at [Operator Delegation Reference](/develop/extension/operator-delegation-reference).
