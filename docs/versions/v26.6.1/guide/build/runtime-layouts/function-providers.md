...
See [AWS Lambda Platform Guide](/versions/v26.6.1/guide/development/aws-lambda) for detailed deployment instructions.
...
See [Azure Functions Testing Guide](/versions/v26.6.1/guide/build/runtime-layouts/search-azure-functions) for detailed deployment instructions.
...
- See [Function Platform Architecture](/versions/v26.6.1/guide/evolve/compiler-pipeline-architecture.md) for implementation details
- Consult [Operations Playbook](/versions/v26.6.1/guide/operations/operators-playbook.md) for production guidance
