...
This page is the current roadmap front door. The older detailed notebook is archived at [Roadmap Archive](/versions/v26.7.1/evolve/tpfgo/roadmap-archive).
...
| Need | Page |
| --- | --- |
| DDD and boundary alignment | [DDD Alignment](/versions/v26.7.1/evolve/tpfgo/ddd-alignment) |
| Application design tradeoffs | [Design Spectrum](/versions/v26.7.1/evolve/tpfgo/design-spectrum) |
| Example implementation notes | [TPFGo Example](/versions/v26.7.1/develop/tpfgo-example) |
| User-facing checkpoint boundary | [Checkpoint Handoff](/versions/v26.7.1/deploy/orchestrator-runtime/checkpoint-handoff) |
| Public state model | [State Model](/versions/v26.7.1/design/state-model) |
