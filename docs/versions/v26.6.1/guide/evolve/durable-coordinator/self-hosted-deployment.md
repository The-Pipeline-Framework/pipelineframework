...
For the role split behind coordinator, transition worker, step/runtime services, and the historical `orchestrator-svc` name, see [Coordinator And Worker Topology](/versions/v26.6.1/guide/evolve/durable-coordinator/coordinator-worker-topology).
...
For metric names and observability surfaces, use the operations guides for [Metrics](/versions/v26.6.1/guide/operations/observability/metrics), [Replay & Live Topology](/versions/v26.6.1/guide/operations/observability/replay), and the [Operator Playbook](/versions/v26.6.1/guide/operations/operators-playbook).
