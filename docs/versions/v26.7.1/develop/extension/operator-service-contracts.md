...
For implementation details, see [Operator Delegation Reference](/versions/v26.7.1/develop/extension/operator-delegation-reference#option-2--use-domain-types).
