...
- Build/CI failures: for failure signatures and triage flow, use [Operator Build Troubleshooting](/versions/v26.6.2/develop/operators-build-troubleshooting).

## Related

- [Operators](/versions/v26.6.2/design/operators)
- [External Library Delegation](/versions/v26.6.2/develop/external-library-delegation)
- [Mappers and DTOs](/versions/v26.6.2/develop/mappers-and-dtos)
- [Extending TPF with Operator Libraries](/versions/v26.6.2/develop/extension/operator-libraries)
