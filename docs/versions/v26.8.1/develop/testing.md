...
::: tip Runtime Scope
Quarkus is the mature production test surface today. Spring support currently has limited smoke coverage for generated local/REST unary flows; see [Spring Support Status](/versions/v26.8.1/develop/spring-support) before relying on Spring tests for production applications.
:::
...
Application tests (this guide) focus on your pipeline behavior. If you are contributing to the framework itself, use the maintainer guide at [Testing Guidelines](/versions/v26.8.1/evolve/testing-guidelines).
