...
- [Annotation Processor Guide](/versions/v26.2.5/guide/evolve/annotation-processor/)
- [Phases and Flow](/versions/v26.2.5/guide/evolve/annotation-processor/phases-and-flow)
- [Models and Bindings](/versions/v26.2.5/guide/evolve/annotation-processor/models-and-bindings)
- [Generation and Rendering](/versions/v26.2.5/guide/evolve/annotation-processor/generation-and-rendering)
- [Current Architecture](/versions/v26.2.5/guide/evolve/annotation-processor/current-architecture)
...
- [Annotation Processor Architecture (Compat)](/versions/v26.2.5/guide/evolve/annotation-processor-architecture)
