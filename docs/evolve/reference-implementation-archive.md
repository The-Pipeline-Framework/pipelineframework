...
This scaffold walkthrough predates the current IA and connector/FCIS positioning. Use [Reference Implementations](/evolve/reference-implementation) for the current reading path.
:::
