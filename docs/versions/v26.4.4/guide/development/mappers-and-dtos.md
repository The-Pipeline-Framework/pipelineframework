...
The Java type names you choose in your pipeline YAML (or the web UI) determine DTO/domain field types and the default proto mappings. See [Data Types](/versions/v26.4.4/guide/evolve/data-types) for the current type list and defaults.
