...
This page is the canonical TPF guide for `FUNCTION` platform builds that target AWS Lambda. For the broader multi-cloud function story, pair it with the [Multi-Cloud Function Providers Guide](/versions/v26.8.1/deploy/function-providers).
...
- [Multi-Cloud Function Providers Guide](/versions/v26.8.1/deploy/function-providers)
- [Azure Functions Platform](/versions/v26.8.1/deploy/azure-functions)
- [Google Cloud Run Functions Platform](/versions/v26.8.1/deploy/google-cloud-run-functions)
- [Search Azure Verification Lane](/versions/v26.8.1/deploy/search-azure-functions)
...
For the future all-serverless durable coordinator design track, see [All-Serverless Durable Coordinator](/versions/v26.8.1/evolve/durable-coordinator/all-serverless-coordinator). That design is not current Lambda support.
...
- [AWS Lambda SnapStart (Operate)](/versions/v26.8.1/operate/aws-lambda-snapstart)
- [Configuration (Overview)](/versions/v26.8.1/develop/configuration/)
