...
This guide summarizes how TPF aligns with DDD concepts today, where it diverges, and what we intend to improve. It captures the key ideas from the [checkpoint-pipeline discussion](/versions/v26.4.5/guide/evolve/tpfgo/roadmap) so newcomers can quickly orient themselves.
