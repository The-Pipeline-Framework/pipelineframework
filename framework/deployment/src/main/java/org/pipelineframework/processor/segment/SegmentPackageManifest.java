...
/** Static compiler manifest published by a segment artifact. */
public record SegmentPackageManifest(
    int schemaVersion,
    String namespace,
    Artifact artifact,
    ...
    public SegmentPackageManifest {
        if (schemaVersion != CURRENT_SCHEMA_VERSION) {
            throw new IllegalArgumentException("Unsupported segment manifest schemaVersion " + schemaVersion);
        }
