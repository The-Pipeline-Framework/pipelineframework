...
class QueueAsyncRedriveFlowTest {
  ...
  @Test
  void remoteOutcomeUnknownRequiresExplicitFailedRedriveBeforeRequeue() {
    ...
    ExecutionRedriveResult result = flow.redrive("tenant-1", "exec-1", null, true, "confirmed disposition")
        .await().indefinitely();
