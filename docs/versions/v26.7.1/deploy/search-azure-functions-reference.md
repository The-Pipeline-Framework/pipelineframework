...
# Search Azure Functions Reference

::: tip Reference Appendix
This is the original long-form Search Azure Functions reference. Start with [Search Azure Functions Verification Lane](/versions/v26.7.1/deploy/search-azure-functions), [Azure Functions Deployment Walkthrough](/versions/v26.7.1/deploy/azure-functions-deployment-walkthrough), or [Azure Functions Troubleshooting](/versions/v26.7.1/deploy/azure-functions-troubleshooting) for the shorter canonical path.
:::
...
Maintainer-only notes for GitHub OIDC subjects and workflow dispatch details live in [CI Guidelines](/versions/v26.7.1/evolve/ci-guidelines#search-cloud-example-workflows).
...
- Review [AWS Lambda Platform (Development)](/versions/v26.7.1/deploy/aws-lambda) for Function platform concepts
