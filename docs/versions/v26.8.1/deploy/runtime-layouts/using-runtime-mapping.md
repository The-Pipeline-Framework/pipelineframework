...
For `pipeline.platform=FUNCTION` (serverless/function runtime target; see [Configuration](/versions/v26.8.1/develop/configuration/)), runtime mapping and function transport contract metadata work together:
