...
Caching works especially well alongside persistence: persistence keeps the durable business record, while cache keeps reusable derived outputs close at hand. See [State, Replay, and Queryable Data](/value/state-replay-and-queryable-data) and [Cache vs Persistence](/design/caching/cache-vs-persistence) for that bigger picture.
...
- [Configuration](/design/caching/configuration)
- [Policies](/design/caching/policies)
- [Invalidation](/design/caching/invalidation)
- [Search replay walkthrough](/design/caching/replay-walkthrough)
- [Cache key strategy](/design/caching/key-strategy)
