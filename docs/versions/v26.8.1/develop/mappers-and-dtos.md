...
Logical type names in pipeline YAML determine the generated contract; Java bindings and application-owned mappers connect it to DTO and domain types. See the [Pipeline Template DSL](/versions/v26.8.1/develop/pipeline-template-dsl) for the type model and defaults.
