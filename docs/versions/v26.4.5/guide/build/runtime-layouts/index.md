...
- Validation behavior ([`auto` = best-effort fallback placement, `strict` = fail on unmapped/mismatched placement](/versions/v26.4.5/guide/evolve/runtime-mapping/schema#validation)).
...
- [POM vs Layout Matrix](/versions/v26.4.5/guide/build/runtime-layouts/pom-layout-matrix)
...
- [CSV Payments Pipeline-Runtime Walkthrough](/versions/v26.4.5/guide/build/runtime-layouts/csv-payments-pipeline-runtime)
- [CSV Payments Monolith Walkthrough](/versions/v26.4.5/guide/build/runtime-layouts/csv-payments-monolith)
- [Search Lambda Verification Lane](/versions/v26.4.5/guide/build/runtime-layouts/search-lambda)
