...
Quarkus is the mature production runtime today. Spring support has started for a limited local/REST unary path; see [Spring Support Status](/versions/v26.6.2/develop/spring-support) before planning Spring-based applications.
...
- [Item Reject Sink](/versions/v26.6.2/develop/item-reject-sink)
- [Mappers and DTOs](/versions/v26.6.2/develop/mappers-and-dtos)
- [Testing](/versions/v26.6.2/develop/testing)
