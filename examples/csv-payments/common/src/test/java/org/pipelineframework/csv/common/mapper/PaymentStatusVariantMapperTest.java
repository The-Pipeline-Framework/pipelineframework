...
class PaymentStatusVariantMapperTest {
  ...
  void approvedStatusRoundTripsThroughGrpcMapper() {
    ApprovedPaymentStatus status = PaymentStatusVariantMapperTestData.approvedStatus();
  ...
  void unapprovedStatusRoundTripsThroughGrpcMapper() {
    UnapprovedPaymentStatus status = PaymentStatusVariantMapperTestData.unapprovedStatus();
