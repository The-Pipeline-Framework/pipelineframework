...
For how these APIs relate to coordinator and worker processes, see [Coordinator And Worker Topology](/versions/v26.6.2/evolve/durable-coordinator/coordinator-worker-topology).
