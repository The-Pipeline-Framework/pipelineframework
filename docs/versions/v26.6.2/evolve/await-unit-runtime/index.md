...
This guide is implementation-facing. Application-facing design guidance lives in [Await Boundaries](/versions/v26.6.2/design/await-boundaries). Runtime setup lives in [Await runtime setup](/versions/v26.6.2/deploy/orchestrator-runtime/await).

For the longer-term orchestration boundary that can move await units out of each app-hosted orchestrator, see [Durable Coordinator](/versions/v26.6.2/evolve/durable-coordinator/).

## Guide Pages

1. [Model](/versions/v26.6.2/evolve/await-unit-runtime/) explains the durable records and cardinality semantics.
2. [Sequences](/versions/v26.6.2/evolve/await-unit-runtime/sequences) shows unary, stream, aggregate, timeout, and resume flows.
3. [Patterns](/versions/v26.6.2/evolve/await-unit-runtime/patterns) explains the architectural patterns and why the unit model fixed the design.
4. [Limitations And Debt](/versions/v26.6.2/evolve/await-unit-runtime/operations-and-debt) tracks implementation limitations and follow-up work.
