...
- Lambda development model and gateway choices: [AWS Lambda Platform (Development)](/versions/v26.4.4/guide/development/aws-lambda)
- Lambda runtime operations and SnapStart: [AWS Lambda SnapStart (Operate)](/versions/v26.4.4/guide/operations/aws-lambda-snapstart)
