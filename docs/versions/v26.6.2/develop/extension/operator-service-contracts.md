...
For implementation details, see [Operator Delegation Reference](/versions/v26.6.2/develop/extension/operator-delegation-reference#option-2--use-domain-types).
