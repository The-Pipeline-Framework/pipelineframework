...
::: note
In durable self-host HA, `orchestrator-svc` is a module/artifact name, not always the whole orchestration role. The durable coordinator and transition worker roles are selected by runtime config. See [Coordinator And Worker Topology](/versions/v26.7.1/evolve/durable-coordinator/coordinator-worker-topology).
:::
...
- Validation behaviour ([`auto` = best-effort fallback placement, `strict` = fail on unmapped/mismatched placement](/versions/v26.7.1/evolve/runtime-mapping/schema#validation)).
...
- [POM vs Layout Matrix](/versions/v26.7.1/deploy/runtime-layouts/pom-layout-matrix)
- [Using Runtime Mapping](/versions/v26.7.1/deploy/runtime-layouts/using-runtime-mapping)
- [Maven Migration Playbook](/versions/v26.7.1/deploy/runtime-layouts/maven-migration)
- [CSV Payments Pipeline-Runtime Walkthrough](/versions/v26.7.1/deploy/runtime-layouts/csv-payments-pipeline-runtime)
- [CSV Payments Monolith Walkthrough](/versions/v26.7.1/deploy/runtime-layouts/csv-payments-monolith)
- [Search Lambda Verification Lane](/versions/v26.7.1/deploy/search-lambda)
