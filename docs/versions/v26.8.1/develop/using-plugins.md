...
- **Aspects**: declarations that say where and when a plugin should run, such as before or after a step; see the [aspect semantics reference](/versions/v26.8.1/evolve/aspects/semantics) for the formal rules.
