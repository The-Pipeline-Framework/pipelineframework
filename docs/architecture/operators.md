...
This exact chain is available in [`pipelineframework-examples/ai-sdk/config/pipeline.yaml`](https://github.com/The-Pipeline-Framework/pipelineframework-examples/blob/main/ai-sdk/config/pipeline.yaml).
...
- gRPC transport: requires protobuf descriptors and mapper-compatible bindings for delegated/operator paths (see [Application Configuration](/develop/configuration/)).
...
- [Operator Runtime Operations](/operate/operators)
- [Operator Playbook](/operate/operators-playbook)
- [Operator Troubleshooting](/operate/operators-troubleshooting)
- [Operator Internals](/evolve/operators/internals)
