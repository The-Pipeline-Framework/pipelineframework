...
This guide summarizes how TPF aligns with DDD concepts today, where it diverges, and what we intend to improve. It captures the key ideas from the [checkpoint-pipeline discussion](/versions/v26.8.1/evolve/tpfgo/roadmap) so newcomers can quickly orient themselves.
