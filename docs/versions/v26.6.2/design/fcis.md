...
| Admit files, object-store entries, or external payloads | connectors such as [Object Ingest](/versions/v26.6.2/design/object-ingest) |
| Wait for human approval, webhook callbacks, provider responses, or long-running jobs | [Await Boundaries](/versions/v26.6.2/design/await-boundaries) |
| Record and replay-safe external effects such as indexing, tickets, emails, or provisioning | [Command Steps](/versions/v26.6.2/deploy/orchestrator-runtime/command) |
| Call a synchronous existing method or remote request/response endpoint | [Operators](/versions/v26.6.2/design/operators) |
| Store business outputs for later query or audit | [Persistence](/versions/v26.6.2/design/persistence) |
| Reuse expensive derived outputs | [Caching](/versions/v26.6.2/design/caching/) |
| Hand off stable output to a separately owned downstream pipeline | [Checkpoint Handoff](/versions/v26.6.2/deploy/orchestrator-runtime/checkpoint-handoff) |
