...
- [Application Structure](/versions/v26.6.2/design/application-structure)
- [Pipeline Compilation](/versions/v26.6.2/develop/pipeline-compilation/)
- [Configuration](/versions/v26.6.2/develop/configuration/)
- [Object Ingest](/versions/v26.6.2/design/object-ingest)
...
Use [MCP and Template Generation](/versions/v26.6.2/develop/mcp-template-generation) when you need automation or CI-driven scaffold generation.

See [Template Generator Reference](/versions/v26.6.2/evolve/template-generator) for the lower-level reference.
