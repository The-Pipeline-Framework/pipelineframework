...
- **Aspects**: declarations that say where and when a plugin should run, such as before or after a step; see the [aspect semantics reference](/versions/v26.7.1/evolve/aspects/semantics) for the formal rules.
