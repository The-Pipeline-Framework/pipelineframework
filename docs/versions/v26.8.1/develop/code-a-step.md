...
The logical type names in pipeline YAML drive the generated contract. Java bindings and application-owned mappers connect that contract to DTO and domain types. See the [Pipeline Template DSL](/versions/v26.8.1/develop/pipeline-template-dsl) for the type model and defaults.
...
See [Item Reject Sink](/versions/v26.8.1/develop/item-reject-sink) for the canonical model and wiring.
