...
The connector uses the application's Quarkus datasource, ORM configuration, and JPA entities. It remains separate from the [Persistence Plugin](/versions/v26.8.1/design/persistence), even when both features use the same database.
