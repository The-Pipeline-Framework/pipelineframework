...
- gRPC transport: requires protobuf descriptors and mapper-compatible bindings for delegated/operator paths (see [Application Configuration](/versions/v26.2.5/guide/application/configuration)).
...
- [Application Configuration](/versions/v26.2.5/guide/application/configuration)
- [Developing with Operators](/versions/v26.2.5/guide/development/operators)
- [Operator Runtime Operations](/versions/v26.2.5/guide/operations/operators)
- [Operator Playbook](/versions/v26.2.5/guide/operations/operators-playbook)
- [Operator Troubleshooting](/versions/v26.2.5/guide/operations/operators-troubleshooting)
- [Operator Internals](/versions/v26.2.5/guide/evolve/operators-internals)
