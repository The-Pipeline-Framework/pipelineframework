...
The connector uses the application's Quarkus datasource, ORM configuration, and JPA entities. It remains separate from the [Persistence Plugin](/versions/v26.7.1/design/persistence), even when both features use the same database.
