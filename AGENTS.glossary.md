...
- **Block**: a reusable packaged functional-core pipeline definition imported at compile time and linked through ordinary pipeline composition. A block is not a separate runtime execution unit or registry entry.
