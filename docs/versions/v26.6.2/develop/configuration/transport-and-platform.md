...
- [Pipeline YAML](/versions/v26.6.2/develop/configuration/all-settings#pipeline-yaml)
- [REST Path Overrides](/versions/v26.6.2/develop/configuration/all-settings#rest-path-overrides-build-time)
