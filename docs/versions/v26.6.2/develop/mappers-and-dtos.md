...
The Java type names you choose in your pipeline YAML (or the web UI) determine DTO/domain field types and the default proto mappings. See [Data Types](/versions/v26.6.2/evolve/data-types) for the current type list and defaults.
