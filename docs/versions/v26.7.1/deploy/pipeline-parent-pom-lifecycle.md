...
> - [Using the Canvas Designer](/versions/v26.7.1/design/pipeline-studio/canvas-guide)
...
> - [CSV Payments POM Lifecycle](/versions/v26.7.1/deploy/csv-payments-pom-lifecycle) for an example-specific variant
