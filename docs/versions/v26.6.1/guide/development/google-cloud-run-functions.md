...
This page is the canonical TPF guide for `FUNCTION` platform builds that target Google Cloud Run functions. For the broader provider matrix, pair it with the [Multi-Cloud Function Providers Guide](/versions/v26.6.1/guide/build/runtime-layouts/function-providers).
...
- [AWS Lambda Platform](/versions/v26.6.1/guide/development/aws-lambda)
