...
- [Schema and Semantics](/evolve/runtime-mapping/schema)
- [Synthetic Step Identifiers](/evolve/runtime-mapping/synthetics)
- [Annotation Processing and Transport](/evolve/runtime-mapping/annotation-processing)
- [Validation, Migration, and Examples](/evolve/runtime-mapping/validation-migration-examples)
- [Build Topologies (What Is Real Today)](/evolve/runtime-mapping/build-topologies)
- [Cheat Sheet](/evolve/runtime-mapping/cheat-sheet)
...
- [TDD Plan](/evolve/runtime-mapping/tdd-plan)
- [Implementation Plan](/evolve/runtime-mapping/implementation-plan)
