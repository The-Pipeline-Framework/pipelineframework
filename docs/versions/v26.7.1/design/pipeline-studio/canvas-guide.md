...
- Use YAML or [MCP/template generation](/versions/v26.7.1/develop/mcp-template-generation) to create or refresh a codebase
...
- you need [Object Ingest](/versions/v26.7.1/design/object-ingest),
- you need [Await Boundaries](/versions/v26.7.1/design/await-boundaries),
- you need [Checkpoint Handoff](/versions/v26.7.1/deploy/orchestrator-runtime/checkpoint-handoff),
- you need advanced [Configuration](/versions/v26.7.1/develop/configuration/),
- you are validating [Spring support](/versions/v26.7.1/develop/spring-support).
