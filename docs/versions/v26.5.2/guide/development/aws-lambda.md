...
This page is the canonical TPF guide for `FUNCTION` platform builds that target AWS Lambda. For the broader multi-cloud function story, pair it with the [Multi-Cloud Function Providers Guide](/versions/v26.5.2/guide/build/runtime-layouts/function-providers).
...
- [Azure Functions Platform](/versions/v26.5.2/guide/development/azure-functions)
- [Google Cloud Run Functions Platform](/versions/v26.5.2/guide/development/google-cloud-run-functions)
- [Search Azure Functions Testing Guide](/versions/v26.5.2/guide/build/runtime-layouts/search-azure-functions)
...
- [Configuration (Overview)](/versions/v26.5.2/guide/application/configuration)
