...
For the deployment role split, see [Coordinator And Worker Topology](/versions/v26.7.1/evolve/durable-coordinator/coordinator-worker-topology). This page focuses on the worker protocol contract after that split has already selected a worker.
