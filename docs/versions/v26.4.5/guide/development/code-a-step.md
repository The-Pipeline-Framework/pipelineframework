...
Note: The Java type names you choose in your pipeline YAML (or the web UI) drive the DTO/domain fields and the generated proto mappings. See [Data Types](/versions/v26.4.5/guide/evolve/data-types) for the full list and defaults.
...
See [Item Reject Sink](/versions/v26.4.5/guide/development/item-reject-sink) for the canonical model and wiring.
