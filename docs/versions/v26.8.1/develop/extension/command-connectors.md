...
For YAML setup, see [Command Steps](/versions/v26.8.1/deploy/orchestrator-runtime/command). This page covers the Java code.
...
both layers invokes the provider. See [Cache Policies](/versions/v26.8.1/design/caching/policies) and
[Capture, Replay, and Persistence](/versions/v26.8.1/design/jpa-query-connector/capture-and-persistence).
