...
For current advanced application design, keep YAML as the canonical model and use [Pipeline Compilation](/versions/v26.7.1/develop/pipeline-compilation/) to understand what the framework validates and generates.
...
- [Template Generator Reference](/versions/v26.7.1/evolve/template-generator)
- [Pipeline Compilation](/versions/v26.7.1/develop/pipeline-compilation/)
- [Pipeline Studio](/versions/v26.7.1/design/pipeline-studio/)
