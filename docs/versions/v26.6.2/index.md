...
hero:
  ...
  actions:
    - theme: alt
      text: Quick Start
      link: /versions/v26.6.2/design/pipeline-studio/
    - theme: brand
...
<div class="home-capability-grid">
  <a class="home-capability-card" href="/versions/v26.6.2/develop/pipeline-compilation/">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/develop/code-a-step">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/design/object-ingest">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/deploy/runtime-layouts/">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/value/state-replay-and-queryable-data">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/operate/observability/">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/design/await-boundaries">
  ...
  <a class="home-capability-card" href="/versions/v26.6.2/develop/mappers-and-dtos">
...
Start with [pipeline compilation](/versions/v26.6.2/develop/pipeline-compilation/) when you want the build-time generation model, or [code a step](/versions/v26.6.2/develop/code-a-step) when you want to implement the function itself.
...
The exact config value for this mode is `QUEUE_ASYNC`; start with the [Orchestrator Runtime](/versions/v26.6.2/deploy/orchestrator-runtime/) guide before using it in production.
...
[Plugins](/versions/v26.6.2/develop/using-plugins) add declared cross-cutting work such as persistence, cache, telemetry, and logging. An **aspect** is the rule that says where the plugin runs, for example before or after a step; the plugin provides the implementation.
...
See [State, Replay, and Queryable Data](/versions/v26.6.2/value/state-replay-and-queryable-data) for the full persistence-and-caching story.
...
- [Quick Start](/versions/v26.6.2/design/pipeline-studio/) for the fastest path to a runnable scaffold.
- [Pipeline Compilation](/versions/v26.6.2/develop/pipeline-compilation/) for YAML-first generation and build-time validation.
- [Operators](/versions/v26.6.2/develop/operators) for reusing existing Java methods or remote endpoints.
- [Runtime Layouts](/versions/v26.6.2/deploy/runtime-layouts/) for logical placement versus Maven/container build topology.
- [AWS Lambda Platform](/versions/v26.6.2/deploy/aws-lambda) for the canonical `FUNCTION` platform guide.
- [Azure Functions Platform](/versions/v26.6.2/deploy/azure-functions) for Azure development-time guidance.
- [Google Cloud Run Functions Platform](/versions/v26.6.2/deploy/google-cloud-run-functions) for the Google function-platform path.
- [Multi-Cloud Function Providers](/versions/v26.6.2/deploy/function-providers) for provider-specific function deployment targets.
- [Orchestrator Runtime](/versions/v26.6.2/deploy/orchestrator-runtime/) for synchronous execution, background execution, crash recovery, and DLQ behaviour.
- [Using Plugins](/versions/v26.6.2/develop/using-plugins) for persistence, cache, telemetry, and logging extensions.
- [TPFGo Example](/versions/v26.6.2/develop/tpfgo-example) for checkpoint handoff between pipelines.
