...
- Lambda development model and gateway choices: [AWS Lambda Platform (Development)](/versions/v26.5.1/guide/development/aws-lambda)
- Lambda runtime operations and SnapStart: [AWS Lambda SnapStart (Operate)](/versions/v26.5.1/guide/operations/aws-lambda-snapstart)
