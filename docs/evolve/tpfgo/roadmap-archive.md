...
This is the original long-form pessimist notebook. Use [TPFGo Roadmap](/evolve/tpfgo/roadmap) for the current reading path.
:::
...
- [TPF and DDD Alignment](/evolve/tpfgo/ddd-alignment)
- [Application Design Spectrum](/evolve/tpfgo/design-spectrum)
