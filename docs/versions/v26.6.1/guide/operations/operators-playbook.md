...
- Build transport and platform defaults from `pipeline.yaml` (the pipeline manifest, typically at the repo root or a service `config/` directory; see [Configuration Reference](/versions/v26.6.1/guide/build/configuration/)).
...
- [Operator Troubleshooting Matrix](/versions/v26.6.1/guide/operations/operators-troubleshooting)
- [Operator Build Troubleshooting](/versions/v26.6.1/guide/development/operators-build-troubleshooting)
- [Error Handling and Recovery](/versions/v26.6.1/guide/operations/error-handling)
- [Observability](/versions/v26.6.1/guide/operations/observability/)
