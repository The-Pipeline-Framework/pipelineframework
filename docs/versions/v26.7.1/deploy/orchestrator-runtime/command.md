...
Start here when you need to declare a command step in `pipeline.yaml`. For connector code, see [Writing Command Connectors](/versions/v26.7.1/develop/extension/command-connectors). For runtime signals, see [Replay & Live Topology](/versions/v26.7.1/operate/observability/replay) and [Metrics](/versions/v26.7.1/operate/observability/metrics).
...
- [Writing Command Connectors](/versions/v26.7.1/develop/extension/command-connectors)
- [Queue-Async Runtime](/versions/v26.7.1/deploy/orchestrator-runtime/queue-async)
