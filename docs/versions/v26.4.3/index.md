...
- **Clear extension points**: Use [Using Plugins](/versions/v26.4.3/guide/development/using-plugins) and [Aspect Semantics](/versions/v26.4.3/guide/evolve/aspects/semantics) as primary references.
...
- **Fast onboarding and testing**: Design visually with Canvas and validate behavior via [Testing with Testcontainers](/versions/v26.4.3/guide/development/testing).
