...
Application-facing design guidance lives in [Await Boundaries](/versions/v26.6.2/design/await-boundaries). Runtime setup lives in [Await runtime setup](/versions/v26.6.2/deploy/orchestrator-runtime/await). Operational guidance lives in [Await Boundary Operations](/versions/v26.6.2/operate/await-boundaries).
