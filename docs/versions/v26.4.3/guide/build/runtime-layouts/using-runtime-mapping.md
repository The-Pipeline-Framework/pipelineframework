...
For `pipeline.platform=FUNCTION` (serverless/function runtime target; see [Configuration Reference](/versions/v26.4.3/guide/build/configuration/)), runtime mapping and function transport contract metadata work together:
