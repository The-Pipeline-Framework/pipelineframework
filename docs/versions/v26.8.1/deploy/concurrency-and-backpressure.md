...
These mechanisms are complementary. Backpressure does not prevent rapid connection-refused loops, and a circuit does not replace demand propagation or provider-capacity sizing. See [Execution Safety](/versions/v26.8.1/design/execution-safety) and [Operate Circuit Protection](/versions/v26.8.1/operate/circuit-breakers).
