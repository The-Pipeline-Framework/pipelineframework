...
For low-level details, see [Operator Delegation Reference](/versions/v26.8.1/develop/extension/operator-delegation-reference#option-1--use-operator-types-directly).
