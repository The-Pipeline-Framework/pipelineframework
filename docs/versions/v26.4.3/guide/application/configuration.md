...
- [Configuration Reference](/versions/v26.4.3/guide/build/configuration/) for full build-time and runtime key catalog
- [Performance](/versions/v26.4.3/guide/development/performance) for throughput/latency tuning
...
- Lambda development model and gateway choices: [AWS Lambda Platform (Development)](/versions/v26.4.3/guide/development/aws-lambda)
- Lambda runtime operations and SnapStart: [AWS Lambda SnapStart (Operate)](/versions/v26.4.3/guide/operations/aws-lambda-snapstart)
