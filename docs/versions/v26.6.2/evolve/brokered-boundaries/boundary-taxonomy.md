...
Serialization choices such as protobuf, JSON, bytes, or payload references belong to payload policy, not broker fit. See [Envelope And Data Policy](/versions/v26.6.2/evolve/brokered-boundaries/envelope-and-data-policy).
